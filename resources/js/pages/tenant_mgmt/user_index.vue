...
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: 'Tenant Users',
        href: route('users.index', { tenant: props.tenant }),
    },
];
...
function sort(field: string) {
    router.get(
        route('users.index', { tenant: props.tenant }),
        {
            sort: field,
...
<template>
        <Head title="Tenant User Management" />
        ...
        <div class="flex flex-col gap-6 p-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-sidebar-border/70 p-6">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Tenant User Management</h2>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage users for {{props.tenant}}</p>
                    </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            <tr v-for="user in users.data" :key="user.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <Link
                                        :href="route('users.edit', { tenant: props.tenant, user: user.id })"
